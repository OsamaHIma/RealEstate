const ContactCard = ({ icon, title, num, btnText }) => {
  return (
    <div className="rounded-md p-3 m-2 shadow w-56 min-h-32 dark:bg-black/10">
      ...
      <button className="w-[97%] bg-slate-100 dark:bg-slate-900 text-dark-blue rounded-md mx-auto py-2 px-4 font-bold hover:scale-110 transition-all ease-in">
        {btnText}
      </button>
    </div>
  );
